...
TaskOps [rollback](../../../Projects/1_project/taskops-cicd/scripts/rollback.sh) selects the recorded previous tag and recreates the stack, while [backup](../../../Projects/1_project/taskops-cicd/scripts/backup_db.sh) handles SQLite data separately. This demonstrates why image rollback and data recovery are distinct. File evidence cannot prove the remote host exists or a deployment succeeded.
